...
public class FletchingTableREIPlugin implements REIClientPlugin {
    ...
    public void registerScreens(ScreenRegistry registry) {
        registry.registerClickArea(screen -> new Rectangle(screen.leftPos + 100, screen.topPos + 34, 25, 20), FletchingTableBlockScreen.class, FletchingTableREICategory.CATEGORY_ID);
    }
