...
public class FletchingTableJEIPlugin implements IModPlugin {
    ...
    public @NotNull Identifier getPluginUid() {
        return Identifier.fromNamespaceAndPath(Constants.MOD_ID, "jei_fletching_table");
    }

    @Override
    public void registerCategories(IRecipeCategoryRegistration registration) {
        registration.addRecipeCategories(new FletchingTableJEICategory(registration.getJeiHelpers().getGuiHelper()));
    }
    ...
    public void registerRecipes(@NotNull IRecipeRegistration registration) {
        ...
        registration.addRecipes(FletchingTableJEICategory.FLETCHING_TABLE_RECIPE_TYPE, jeiRecipes);
    }

    @Override
    public void registerGuiHandlers(IGuiHandlerRegistration registration) {
        registration.addRecipeClickArea(FletchingTableBlockScreen.class, 100, 34, 25, 20, FletchingTableJEICategory.FLETCHING_TABLE_RECIPE_TYPE);
    }

    @Override
    public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
        registration.addRecipeCatalyst(new ItemStack(Blocks.FLETCHING_TABLE.asItem()), FletchingTableJEICategory.FLETCHING_TABLE_RECIPE_TYPE);
    }

    @Override
    public void registerRecipeTransferHandlers(IRecipeTransferRegistration registration) {
        registration.addRecipeTransferHandler(
                FletchingTableBlockMenu.class,
                ModRegistry.FLETCHING_TABLE_MENU,
                FletchingTableJEICategory.FLETCHING_TABLE_RECIPE_TYPE,
                0, 2,
                3, 36
        );
    }
