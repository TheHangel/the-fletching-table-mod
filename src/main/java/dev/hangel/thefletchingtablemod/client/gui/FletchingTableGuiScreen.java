...
public class FletchingTableGuiScreen extends AbstractContainerScreen<FletchingTableGuiMenu> {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(font, Component.translatable("gui.the_fletching_table_mod.fletching_table_gui.label_empty"), 8, 7, -1);
		guiGraphics.drawString(font, Component.translatable("gui.the_fletching_table_mod.fletching_table_gui.label_inventory"), 8, 71, -1);
	}
