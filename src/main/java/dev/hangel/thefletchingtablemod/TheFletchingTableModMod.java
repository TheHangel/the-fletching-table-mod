...
@Mod("the_fletching_table_mod")
public class TheFletchingTableModMod {
	public static final Logger LOGGER = LogManager.getLogger(TheFletchingTableModMod.class);
	public static final String MODID = "the_fletching_table_mod";

	public TheFletchingTableModMod(IEventBus modEventBus) {
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);

		TheFletchingTableModModMenus.REGISTRY.register(modEventBus);
